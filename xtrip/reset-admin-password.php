<?php
    ...
    if(!isset($_GET["reset-token"]) || !isset($_GET["admin-id"])) {
        ...
        $admin_id = htmlspecialchars(trim($_GET["admin-id"]));
                    ...
                    <div class="col-md-8 col-lg-6 col-xxl-3">
                        <div class="card mb-0">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="text-center text-dark p-3"> Reset Administrator Password </h5>

                                <form action="process/admin/admin-auth.php" method="POST" class="text-dark">
