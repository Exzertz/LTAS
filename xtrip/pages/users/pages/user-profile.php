...
<main id="main" class="main">
    ...
    <?php include_once "../global-includes/page-titles.php"; ?>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade <?php echo htmlspecialchars($active_tab === "overview" ? "show active" : ""); ?> profile-overview custom-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8"> <?php echo htmlspecialchars($first_name); ?> </div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label "> Middle Name </div>
                                    <div class="col-lg-9 col-md-8"> <?php echo htmlspecialchars($middle_name); ?> </div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label "> Last Name </div>
                                    <div class="col-lg-9 col-md-8"> <?php echo htmlspecialchars($last_name); ?> </div>
                                </div>
                            ...
                            <div class="tab-pane fade <?php echo htmlspecialchars($active_tab === "profile" ? "show active" : ""); ?> pt-3" id="edit-information">
                                ...
                                <!-- Profile Edit Form -->
                                <form action="../../process/users/update-profile.php" method="POST" class="custom-form">
                                    ...
                                    <div class="row mb-3">
                                        <label for="gend" class="col-md-4 col-lg-3 col-form-label"> Civil Status: </label>
                                        <div class="col-md-8 col-lg-9">
                                            <select class="form-select" name="civil-status" id="civil_status" required style="height: 40px;">
                                    ...
                                    <div class="row mb-3">
                                        <label for="telephone_num" class="col-md-4 col-lg-3 col-form-label"> Telephone Number (Optional): </label>
                                        <div class="col-md-8 col-lg-9">
                                            <input type="text" class="form-control" id="telephone_num" name="telephone-number" placeholder="Telephone Number(Optional)" value="<?php echo htmlspecialchars($telephone_number); ?>">
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade <?php echo htmlspecialchars($active_tab === "photo" ? "show active" : ""); ?> pt-3" id="picture-edit">
                                ...
                                <!-- Profile Edit Form -->
                                <form action="../../process/users/update-profile.php" method="POST" enctype="multipart/form-data">
